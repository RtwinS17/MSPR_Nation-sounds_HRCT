    ...
    return (
       ...
       <div>
        <form action="submit">
          ...
          <input type="submit" value="Je m'inscris" className='shadow inner bg-Jaune rounded-md p-1 px-3 text-Bleufonce hover:bg-Bleuclair hover:text-Orange hover:font-bold hover:shadow-md' />
          </label>
        </form>
      </div>
        </footer>
